...
public static class Loc
{
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["WorkMode"] = "Work mode: the AI can use this PC (commands, files, internet, clipboard) asking for permission",
        ["WorkTitle"] = "Work mode",
        ["WorkHint"] = "With the terminal button next to Send, the AI can use this PC: run commands, read and write files, download from the internet, use the clipboard and open things. Each action is shown before it happens and you approve it, unless you decide otherwise below. Everything it does is logged.",
        ...
        ["PermSectionHint"] = "What the AI may use on this PC in work mode. \"Ask\" shows each action before it happens; \"Always\" skips the question; \"Never\" hides that resource from the AI.",
        ["PermAsk"] = "Ask",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["WorkMode"] = "Modo trabajo: la IA puede usar este PC (órdenes, ficheros, internet, portapapeles) pidiendo permiso",
        ["WorkTitle"] = "Modo trabajo",
        ["WorkHint"] = "Con el botón de terminal junto a Enviar, la IA puede usar este PC: ejecutar órdenes, leer y escribir ficheros, descargar de internet, usar el portapapeles y abrir cosas. Cada acción se enseña antes de hacerse y la apruebas, salvo que abajo decidas otra cosa. Todo lo que hace queda registrado.",
        ...
        ["PermSectionHint"] = "Qu\u00e9 puede usar la IA de este PC en modo trabajo. \u00abPreguntar\u00bb ense\u00f1a cada acci\u00f3n antes de hacerla; \u00abSiempre\u00bb no pregunta; \u00abNunca\u00bb esconde ese recurso a la IA.",
        ["PermAsk"] = "Preguntar",
