...
public static class Loc
{
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["SearchHfHint"] = "Searches the GGUF repositories on huggingface.co, weighs each result and tells you whether it fits this PC (★ = optimal). Single-file GGUFs only; the usual Q4_K_M quantization is chosen.",
        ["SearchHfSearching"] = "Searching Hugging Face and weighing each result…",
        ["SearchHfNone"] = "Nothing found that fits in this PC's memory. Try another name or a smaller size (1B, 3B, 4B…).",
        ["SearchHfFound"] = "{0} fit this PC ({1} more do not). Order: optimal first, then most downloaded.",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["SearchHfHint"] = "Busca en los repositorios GGUF de huggingface.co, pesa cada resultado y te dice si cabe en este PC (\u2605 = \u00f3ptima). Solo GGUF de un fichero; se elige el cuantizado habitual Q4_K_M.",
        ["SearchHfSearching"] = "Buscando en Hugging Face y pesando cada resultado\u2026",
        ["SearchHfNone"] = "Nada que quepa en la memoria de este PC. Prueba otro nombre o un tama\u00f1o menor (1B, 3B, 4B\u2026).",
        ["SearchHfFound"] = "{0} caben en este PC ({1} m\u00e1s no caben). Orden: primero las \u00f3ptimas, luego las m\u00e1s descargadas.",
