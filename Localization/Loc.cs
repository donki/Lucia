...
public static class Loc
{
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["WorkMode"] = "Work mode: the AI can run commands on this PC (each one is confirmed)",
        ["WorkTitle"] = "Work mode",
        ["WorkHint"] = "With the terminal button next to Send, the AI can run PowerShell commands on this PC to inspect files, build, run tests, use git… Every command is shown before it runs and you approve it (or stop asking for that conversation). Everything it runs is logged.",
        ["WorkFolder"] = "Working folder",
        ["WorkFolderPick"] = "Choose folder",
        ["OpenCommandLog"] = "Open the command log",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["WorkMode"] = "Modo trabajo: la IA puede ejecutar órdenes en este PC (cada una se confirma)",
        ["WorkTitle"] = "Modo trabajo",
        ["WorkHint"] = "Con el botón de terminal junto a Enviar, la IA puede ejecutar órdenes de PowerShell en este PC para mirar ficheros, compilar, pasar tests, usar git… Cada orden se enseña antes de ejecutarse y la apruebas (o dejas de preguntar en esa conversación). Todo lo que ejecuta queda registrado.",
        ["WorkFolder"] = "Carpeta de trabajo",
        ["WorkFolderPick"] = "Elegir carpeta",
        ["OpenCommandLog"] = "Abrir el registro de órdenes",
